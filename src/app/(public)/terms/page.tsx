export const metadata = { title: 'Terms of Service - KUU Matcha' }
  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 prose prose-gray">
        ...
        <h2>2. Private Label &amp; Sourcing Services</h2>
        <p>Our private label and custom sourcing services are available to registered businesses only. All orders are subject to minimum order quantities (MOQ) as specified per product.</p>
        ...
        <p>Payment is accepted via PayPal or bank transfer. For large orders, the payment schedule will be specified in the individual purchase agreement.</p>
        ...
        <h2>7. Contact</h2>
        <p>For questions about these terms, contact us at: maccha.kuu@gmail.com</p>
      </div>
    </div>
  )
}
