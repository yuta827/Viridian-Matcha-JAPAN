-- ==========================================
-- Matcha OEM Site - Database Schema
-- ==========================================
...
CREATE POLICY "news_public_read" ON news_posts FOR SELECT USING (is_published = true);
CREATE POLICY "faq_public_read" ON faq_items FOR SELECT USING (is_visible = true);
CREATE POLICY "banners_public_read" ON banners FOR SELECT USING (is_visible = true);
CREATE POLICY "cms_sections_public_read" ON cms_sections FOR SELECT USING (true);
CREATE POLICY "cms_contents_public_read" ON cms_contents FOR SELECT USING (true);
CREATE POLICY "company_info_public_read" ON company_info FOR SELECT USING (true);
...
-- Service role bypass (auto for service_role key)
CREATE POLICY "admin_all_products" ON products FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_inquiries" ON inquiries FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_quotes" ON quotes FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_orders" ON orders FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_news" ON news_posts FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_faq" ON faq_items FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_banners" ON banners FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_cms_sections" ON cms_sections FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_cms_contents" ON cms_contents FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_company_info" ON company_info FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_site_settings" ON site_settings FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_product_images" ON product_images FOR ALL USING (auth.role() = 'service_role');
CREATE POLICY "admin_all_admin_notes" ON admin_notes FOR ALL USING (auth.role() = 'service_role');
